           ...
           async alert => {
            await alert.forEach(
             ...
             axios.all([
              ...
              axios.get('https://'+cip+':9440/PrismGateway/services/rest/v2.0/alerts/?resolved=false&alert_type_uuid=A106051', {timeout: 5000}),
              ...
              .then(axios.spread((nic,ipmi,offlinedisk,storagehealth,satadom,pm883err,dimmeccerror,smsgdrive,boordrive,nodefail,dimmuccerror) => {
                let axiosresponses = [nic,ipmi,offlinedisk,storagehealth,satadom,pm883err,dimmeccerror,smsgdrive,boordrive,nodefail,dimmuccerror]
